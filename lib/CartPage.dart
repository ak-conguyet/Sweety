                  ...
                  child: Column(
                    children: [
                      Container(
                        ...
                        child: Row(
                          children: [
                            ...
                            Text('All ( $_selectProductCount products)',style: TextStyle(
                      ...
                      Container(
                        ...
                        child: Row(
                          children: [
                            Image.asset('images/icons/coupon.png',width: 24,height: 24,),
                            SizedBox(width: 5,),
                            Text('Sweety coupon',style: TextStyle(
                                fontSize: 15
                            ),),
                            Expanded(child: SizedBox()),
                            Text('Choose the coupon', style: TextStyle(color: Colors.grey, fontSize: 15),),
                            SizedBox(width: 5,),
